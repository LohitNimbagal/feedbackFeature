...
export const ContactCard = ({ loggedIn, handelSubmit }) => {
        ...
        <div className='cardContainer'>
            <div className='card' style={{ height: !loggedIn && '636px' }}>
                ...
                <form className='cardContent'>
                    <TextInput label={'Your Name'} type={'text'} />

                    {!loggedIn &&
                        <>
                            <TextInput label={'Your Email'} type={'email'} />

                            <TextInput label={'Your Mobile Number'} type={'text'} />
                        </>
                    }
                    ...
                    <div className='bottomSection'>
                        ...
                        <div className='textSection'>
                            <textarea type="text" placeholder='Write here...' onChange={e => setText(e.target.value)}/>
